...
class ReverseWordsView: UIView {
    ...
    func addSubViews() {
        ...
        self.addSubview(mainTitleTextLable)
    ...
    func setConstraints() {
        ...
        NSLayoutConstraint.activate([topTitleTextLabel.heightAnchor.constraint(equalToConstant: 22),
                                     topTitleTextLabel.leadingAnchor.constraint(equalTo: self.topView.leadingAnchor,
                                                                                constant: SizesConstants.Indents.leftIndent),
                                     topTitleTextLabel.trailingAnchor.constraint(equalTo: self.topView.trailingAnchor,
                                                                                 constant: SizesConstants.Indents.rightIndent),
        ...
        NSLayoutConstraint.activate([mainTitleTextLable.heightAnchor.constraint(equalToConstant: 41),
                                     mainTitleTextLable.leadingAnchor.constraint(equalTo: self.leadingAnchor, constant:
                                                                                    SizesConstants.Indents.leftIndent),
                                     mainTitleTextLable.trailingAnchor.constraint(equalTo: self.trailingAnchor, constant:
                                                                                    SizesConstants.Indents.rightIndent),
                                     mainTitleTextLable.topAnchor.constraint(equalTo: self.topAnchor, constant: 152)])
        ...
        NSLayoutConstraint.activate([textToReverseTextField.heightAnchor.constraint(equalToConstant: 22),
                                     textToReverseTextField.leadingAnchor.constraint(equalTo:
                                        inputTextView.leadingAnchor, constant: SizesConstants.Indents.leftIndent),
                                     textToReverseTextField.trailingAnchor.constraint(equalTo:
                                         inputTextView.trailingAnchor, constant: SizesConstants.Indents.rightIndent),
